...
public:
	...
	template<typename T>
	using TRangeOutputFunctionPtr = TVoxelRange<T>(FVoxelWorldGeneratorInstance::*)(const FVoxelIntBox& Bounds, int32 LOD, const FVoxelItemStack& Items) const;
...
public:
	...
	template<typename T>
	using TRangeOutputFunctionPtr_Transform = TVoxelRange<T>(FVoxelTransformableWorldGeneratorInstance::*)(const FTransform& LocalToWorld, const FVoxelIntBox& WorldBounds, int32 LOD, const FVoxelItemStack& Items) const;
