...
template<typename T>
FORCEINLINE TVoxelRange<T> FVoxelWorldGeneratorInstance::GetCustomOutputRange(TVoxelRange<T> DefaultValue, FName Name, const FVoxelIntBox& Bounds, int32 LOD, const FVoxelItemStack& Items) const
{
...
template<typename T>
FORCEINLINE TVoxelRange<T> FVoxelTransformableWorldGeneratorInstance::GetCustomOutputRange_Transform(const FTransform& LocalToWorld, TVoxelRange<T> DefaultValue, FName Name, const FVoxelIntBox& Bounds, int32 LOD, const FVoxelItemStack& Items) const
{
...
FORCEINLINE TVoxelRange<v_flt> FVoxelWorldGeneratorInstance::GetValueRange(const FVoxelIntBox& Bounds, int32 LOD, const FVoxelItemStack& Items) const
{
...
FORCEINLINE TVoxelRange<v_flt> FVoxelTransformableWorldGeneratorInstance::GetValueRange_Transform(const FTransform& LocalToWorld, const FVoxelIntBox& WorldBounds, int32 LOD, const FVoxelItemStack& Items) const
{
