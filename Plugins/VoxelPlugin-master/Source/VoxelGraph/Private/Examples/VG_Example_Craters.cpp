...
TMap<FName, int32> UVG_Example_Craters::GetDefaultSeeds() const
{
	return {
		};
}

TVoxelSharedRef<FVoxelTransformableWorldGeneratorInstance> UVG_Example_Craters::GetTransformableInstance()
{
#if VOXEL_GRAPH_GENERATED_VERSION == 1
